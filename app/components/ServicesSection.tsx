...
const Services = () => {
      ...
      <div className="flex items-center justify-center min-h-screen px-8 pt-16 lg:pt-0">
        <div className="max-w-6xl mx-auto w-full">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="text-center lg:text-start mb-16"
          >
  ...
  >
    <div className="bg-gray-100 rounded-lg h-full flex">
      <img 
        alt='Service Webdesign' 
        src='/ServiceWebdesign.png' 
        className="w-full h-auto object-cover rounded-lg self-stretch"
      />
    </div>
  </motion.div>
    ...
    <div className="space-y-6 h-full flex flex-col justify-between">
      ...
      <div className="flex gap-4 pt-6">
        <motion.button 
          ...
          whileTap={{ scale: 0.95 }}
          className="bg-yellow-400 text-black px-6 py-2 font-semibold hover:bg-yellow-500 transition-colors"
        >
          Zu den Leistungen
        </motion.button>
        <motion.button 
          whileHover={{ scale: 1.05 }}
          whileTap={{ scale: 0.95 }}
          className="border-2 border-gray-300 text-gray-700 px-6 py-2 font-semibold hover:border-gray-400 transition-colors flex items-center gap-2"
        >
